...
const fileData = {
    ...
    'mock2-math-72': { name: '冠人信息高数升本通关模拟卷', files: [{ name: '冠人信息高数升本通关模拟卷.pdf', fileUrl: './zhuanshengben/专升本题背资料/机构模拟题（成套）/高数一/冠人信息高数升本通关模拟卷.pdf', type: 'pdf' }, { name: '冠人信息高数升本通关模拟卷答案.pdf', fileUrl: './zhuanshengben/专升本题背资料/机构模拟题（成套）/高数一/冠人信息高数升本通关模拟卷答案.pdf', type: 'pdf' }] },
